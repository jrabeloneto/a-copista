...
export default function Preloader() {
  ...
  useEffect(() => {
    ...
    const temporizador = setTimeout(() => setVisivel(false), 2300)
    return () => clearTimeout(temporizador)
  }, [visivel])

  if (!visivel) return null

  // v3 (pedido do João): CORTINAS DE TEATRO — o brasão se monta no
  // centro do veludo fechado; o miolo apaga e as cortinas abrem
  // para os lados revelando a revista já viva por baixo.
  return (
    <div className="preloader" aria-hidden="true">
      <div className="cortina cortina-esq" />
      <div className="cortina cortina-dir" />
      <div className="preloader-miolo">
